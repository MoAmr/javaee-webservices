 ...
 * generated in the com.webservices.soap.stubs package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetIt_QNAME = new QName("http://soap.webservices.com/", "getIt");
    private final static QName _GetItResponse_QNAME = new QName("http://soap.webservices.com/", "getItResponse");
    private final static QName _Salute_QNAME = new QName("http://soap.webservices.com/", "salute");
    private final static QName _SaluteResponse_QNAME = new QName("http://soap.webservices.com/", "saluteResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.webservices.soap.stubs
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://soap.webservices.com/", name = "getIt")
     ...
     */
    @XmlElementDecl(namespace = "http://soap.webservices.com/", name = "getItResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://soap.webservices.com/", name = "salute")
     ...
     */
    @XmlElementDecl(namespace = "http://soap.webservices.com/", name = "saluteResponse")
